...
<div style="width:100%;max-width:420px;background:#fff;border:1px solid #d0e2f7;border-radius:20px;overflow:hidden;box-shadow:0 8px 32px rgba(26,111,212,0.10)">
    ...
    <div style="padding:2rem">
        ...
        <form method="POST" action="/login">
            ...
            <div style="margin-bottom:1.5rem">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px">
                    ...
                    <a href="/forgot-password" style="font-size:0.78rem;color:#1a6fd4;text-decoration:none">Forgot password?</a>
                </div>
                <input
                    name="password"
                    type="password"
            ...
            <button
                type="submit"
                style="width:100%;padding:11px;border-radius:10px;background:#1a6fd4;color:#fff;font-size:0.95rem;font-weight:600;border:none;cursor:pointer;transition:background 0.18s;font-family:'DM Sans',sans-serif;letter-spacing:0.02em"
        ...
        <div style="display:flex;align-items:center;gap:12px;margin:1.5rem 0">
            ...
            <span style="font-size:0.78rem;color:#8aaac8">New here?</span>
            <div style="flex:1;height:1px;background:#d0e2f7"></div>
        </div>
