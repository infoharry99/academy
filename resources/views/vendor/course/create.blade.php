...
<div style="max-width:620px">
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:2rem;padding-bottom:1.25rem;border-bottom:1.5px solid #d0e2f7">
        ...
        <div>
            <div style="font-family:'Bebas Neue',sans-serif;font-size:1.9rem;letter-spacing:0.05em;color:#0d1f3c">Add Course</div>
            <div style="font-size:0.8rem;color:#8aaac8;font-weight:500">Fill in the details to list a new course</div>
        </div>
    </div>
            ...
            <form method="POST" action="/vendor/course/store">
                ...
                <div style="margin-bottom:1.75rem">
                    ...
                    <textarea
                        name="description"
                        rows="4"
                        placeholder="Describe what students will learn, prerequisites, course duration..."
                ...
                <div style="display:flex;gap:10px">
                    <button
                        type="submit"
                        style="flex:1;padding:11px;border-radius:10px;background:#2563eb;color:#fff;font-size:0.95rem;font-weight:600;border:none;cursor:pointer;transition:background 0.18s;font-family:'DM Sans',sans-serif"
    ...
    {{-- Tips box --}}
    <div style="margin-top:1.25rem;background:#eff6ff;border:1px solid #93c5fd;border-radius:12px;padding:1rem 1.25rem;display:flex;gap:12px;align-items:flex-start">
        <span style="font-size:1.1rem;margin-top:1px">💡</span>
        <div>
            <div style="font-size:0.8rem;font-weight:700;color:#1d4ed8;margin-bottom:4px">Tips for a great course listing</div>
            <ul style="font-size:0.8rem;color:#2563eb;line-height:1.7;padding-left:1rem">
                <li>Use a clear title that highlights the outcome (e.g. "Master X in Y weeks")</li>
                <li>Mention skill level — beginner, intermediate, or advanced</li>
                <li>Include course duration and number of modules in the description</li>
            </ul>
        </div>
    </div>
