            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    @foreach($payments as $payment)
                            ...
                            <tr>
                                <td class="p-4 text-gray-600">#{{ $payment->transaction_id }}</td>

                                <td class="p-4 text-gray-600">{{ $payment->user->name ?? 'N/A' }}</td>
                                ...
                                <td class="p-4 text-gray-600">£{{ $payment->amount }}</td>

                                <td class="p-4 text-gray-600">{{ $payment->created_at->format('d M Y') }}</td>
                                ...
                                {{-- <td class="p-4 text-gray-600">
                                    <a 
                                    href="{{ route('vendor.transaction.view', $payment->id) }}" 
