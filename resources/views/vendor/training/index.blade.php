...
<div style="max-width:860px">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:2rem;padding-bottom:1.25rem;border-bottom:1.5px solid #d0e2f7">
        <div style="display:flex;align-items:center;gap:12px">
            ...
            <div>
                <div style="font-family:'Bebas Neue',sans-serif;font-size:1.9rem;letter-spacing:0.05em;color:#0d1f3c">My Products</div>
                <div style="font-size:0.8rem;color:#8aaac8;font-weight:500">{{ count($products) }} product(s) listed</div>
            </div>
        </div>
    ...
    @if(count($products) === 0)
        ...
        <div style="text-align:center;padding:4rem 2rem;background:#fff;border:1px solid #d0e2f7;border-radius:16px">
            ...
            <div style="font-family:'Bebas Neue',sans-serif;font-size:1.5rem;letter-spacing:0.05em;color:#0d1f3c;margin-bottom:0.5rem">No Products Yet</div>
            <p style="color:#8aaac8;font-size:0.9rem;margin-bottom:1.5rem;font-family:'DM Sans',sans-serif">Create your first product to start selling.</p>
            <a href="/vendor/training/create"
    ...
    @else
        ...
        <div style="background:#fff;border:1px solid #d0e2f7;border-radius:16px;overflow:hidden;box-shadow:0 4px 16px rgba(26,111,212,0.07)">
            ...
            {{-- Table header --}}
            <div style="display:grid;grid-template-columns:1fr 100px 100px 140px;padding:10px 1.25rem;background:#f0f6ff;border-bottom:1.5px solid #d0e2f7">
                ...
                <div style="font-size:0.72rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#8aaac8">Stock</div>
            ...
            >
                ...
                <div style="display:flex;align-items:center;gap:10px">
                    ...
                    <div>
                        <div style="font-size:0.925rem;font-weight:600;color:#0d1f3c;font-family:'DM Sans',sans-serif">{{ $p->title }}</div>
                        <div style="font-size:0.75rem;color:#8aaac8;margin-top:1px;font-family:'DM Sans',sans-serif">
                            SKU: {{ $p->sku ?? '—' }}
                            @if($p->is_featured)
                                &nbsp;<span style="background:#fef3c7;color:#92400e;font-size:0.65rem;font-weight:700;padding:1px 6px;border-radius:4px;letter-spacing:0.04em">FEATURED</span>
                            @endif
                            @if(!$p->is_active)
                                &nbsp;<span style="background:#fee2e2;color:#dc2626;font-size:0.65rem;font-weight:700;padding:1px 6px;border-radius:4px;letter-spacing:0.04em">INACTIVE</span>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div style="margin-top:1rem;display:flex;align-items:center;justify-content:space-between;padding:0.75rem 1rem;background:#f0f6ff;border:1px solid #d0e2f7;border-radius:10px">
            <span style="font-size:0.8rem;color:#4a6890;font-weight:500;font-family:'DM Sans',sans-serif">Showing {{ count($products) }} product(s)</span>
            <a href="/vendor/training/create"
